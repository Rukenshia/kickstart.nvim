...
-- Resize windows
vim.keymap.set('n', '<A-h>', '<C-w><', { desc = 'Decrease width of window' })
vim.keymap.set('n', '<A-l>', '<C-w>>', { desc = 'Increase width of window' })
vim.keymap.set('n', '<A-j>', '<C-w>-', { desc = 'Decrease height of window' })
vim.keymap.set('n', '<A-k>', '<C-w>+', { desc = 'Increase height of window' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --
        tailwindcss = {
          filetypes = { 'html', 'css', 'scss', 'javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'heex', 'elixir', 'eelixir' },
          init_options = {
            userLanguages = {
              elixir = 'html-eex',
              eelixir = 'html-eex',
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        python = { 'isort', 'black', timeout_ms = 2000 },
        --
